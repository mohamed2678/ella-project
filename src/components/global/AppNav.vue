        ...
        <v-row>
          ...
          <v-col cols="4" class="ps-5">
            <div class="parent d-flex justify-space-between align-center">
              <div class="available">
                <span>available 27/7 at</span>
                <br />
                <strong>(011) 11-272968</strong>
              </div>
        ...
        <v-row class="mt-6">
          ...
          <v-col cols="4" class="d-flex justify-end" style="gap: 20px">
            ...
            >
              ...
              <span
                >{{ selectedLang[0].text }} / {{ selectedLang[0].value }}</span
              >
                ...
                <v-list v-model:selected="selectedLang">
                  ...
                  >
                    <v-list-item-title
                      ...
                      style="gap: 10px"
                    >
                      <span v-html="lang.icon"></span> {{ lang.text }} /
                      {{ lang.value }}
                    </v-list-item-title>
                  </v-list-item>
                </v-list>
