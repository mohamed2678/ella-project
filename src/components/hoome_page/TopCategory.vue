<template>
  <div class="top-category py-15">
    <div class="cyber-bunner">
      <img
    ...
    <div class="categories">
      <div class="title d-flex justify-center align-center px-3">
        <h3 class="text-center py-10 flex-grow-1" style="font-weight: 900">
          Top Categories
        </h3>
